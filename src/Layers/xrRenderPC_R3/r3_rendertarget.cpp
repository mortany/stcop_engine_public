...
CRenderTarget::CRenderTarget		()
{
   ...
   if( RImplementation.o.dx10_msaa )
   {
	...
	{
		u32		w = Device.dwWidth, h = Device.dwHeight;
		rt_ssao_temp.create			(r2_RT_ssao_temp, RtCreationParams(w, h, MAIN_VIEWPORT), RtCreationParams(Device.m_SecondViewport.screenWidth, Device.m_SecondViewport.screenHeight, SECONDARY_WEAPON_SCOPE), D3DFMT_G16R16F, SampleCount);
		s_ssao.create				(b_ssao, "r2\\ssao");
